const CACHE_NAME = "diszkertek-napi-v58";
const APP_FILES = [
  "./", "index.html", "css/style.css?v=20260923f", "js/customer-directory.js?v=20260922f", "js/napi-sync.js?v=20260922b", "js/app.js?v=20260923m", "manifest.webmanifest",
