const CACHE_NAME = "diszkertek-napi-v51";
const APP_FILES = [
  "./", "index.html", "css/style.css?v=20260923d", "js/customer-directory.js?v=20260922f", "js/napi-sync.js?v=20260922b", "js/app.js?v=20260923f", "manifest.webmanifest",
